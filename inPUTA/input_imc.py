...
if valor_imc < 18.5:
	print("\nA classificação do seu IMC está como Magreza","procure se alimentar direito!")
elif valor_imc < 24.9:
	print("\nA classificação do seu IMC está como Normal")
elif valor_imc < 29.9:
	print("\nA classificação do seu IMC está como Sobrepeso","procure hábitos alimentares saudáveis.")
elif valor_imc < 39.9:
	print("\nA classificação do seu IMC está como Obesidade!!!","Cuidado, consulte um nutricionista")
else:
